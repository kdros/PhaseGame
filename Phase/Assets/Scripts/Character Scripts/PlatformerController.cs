...
public class PlatformerController : MonoBehaviour 
{
	...
	void  UpdateEffects (){
		...
		if (wereEmittersOn != areEmittersOn) {
			...
			Component[] allEmitters = GetComponentsInChildren<ParticleEmitter>();
			foreach (ParticleEmitter emitter in allEmitters) {
	...
	void  Update ()
	{
		...
		if (activePlatform != null) {
			Vector3 newGlobalPlatformPoint= activePlatform.TransformPoint(activeLocalPlatformPoint); // TODO: check these 2
